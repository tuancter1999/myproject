...
contract QuoterV2 is IQuoterV2, IU2UV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IU2UV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IU2UV3Pool) {
        return IU2UV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IU2UV3SwapCallback
    function U2UV3SwapCallback(
        ...
        IU2UV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IU2UV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
