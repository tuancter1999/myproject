...
import '../../v3-core/interfaces/callback/IU2UV3FlashCallback.sol';
...
/// @notice An example contract using the U2U V3 flash function
contract PairFlash is IU2UV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `U2UV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        PoolAddress.PoolKey memory poolKey =
            PoolAddress.PoolKey({token0: params.token0, token1: params.token1, fee: params.fee1});
        IU2UV3Pool pool = IU2UV3Pool(PoolAddress.computeAddress(factory, poolKey));
